...
sed 's/^/estrellas espaciales, /' EstrellasG2V_10-50_ly.csv > Temp.csv
sed 's/$/enero-2015/' Temp.csv > EstrellasG2V_10-50_ly_ng.csv

tar -cvf Final.tar EstrellasG2V_10-50_ly_ng.csv
gzip Final.tar
